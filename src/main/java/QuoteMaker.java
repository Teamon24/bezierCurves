...
public class QuoteMaker extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        ...
        quoteButton.setOnAction(actionEvent -> {
            ...
            newQuote.setOnMouseClicked(mouseEvent -> {
                selectedQuote.set(newQuote);
                newQuote.toFront();
            });
        });
        ...
        selectedQuote.addListener((observableValue, oldQuote, newQuote) -> {
            if (oldQuote != null) {
    ...
    class MessageBoard extends Pane {
        ...
        Label post(String quote, Color color) {
            ...
            label.setOnMouseExited(mouseEvent -> dropShadow.setInput(null));
